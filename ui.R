  ...
  fluidPage(
    ...
    navbarPage(
          ...
          conditionalPanel(
            ...
            column(
              ...
              panel(
                ...
                column(6, numericInput("limmafc", h5("FC threshold:"), 2, max = 10, min = 1, step = 0.5)),
          ...
          fluidRow(
            column(
              ...
              panel(
                ...
                column(6, numericInput("tcfc", h5("FC threshold:"), 2, max = 10, min = 1, step = 0.5)),
            ...
            column(
              ...
              conditionalPanel(
                ...
                panel(
                  ...
                  column(6, numericInput("kapfc", h5("FC threshold:"), 2, max = 10, min = 1, step = 0.5)),
          ...
          fluidRow(
            column(
              ...
              panel(
                ...
                column(12, numericInput("minseqs", h5("matched seqs threshold"), 50, max = 100, min = 1, step = 1)),
      ...
      tabPanel(
        ...
        hr(),
        h4("Q3: 如果只想分析部分样本，如何操作？"),
        h5("直接对设计文件删减即可，但这并不适用于分析工具的设计文件"),
        hr(),
        h4("Q4: Error: zip error: 'Failed to set mtime on 'profiling_gene_txt//Exp026921_gene.txt' while extracting 'C:\\Users\\***\\AppData\\Local\\Temp\\RtmpCa5Mdw\\62c04ab3afa3d1ce11d77f19\\0.zip'' in file 'zip.c:260'"),
        h5("清理内存，重新上传"),
        hr(),
        h4("Q5: 实验设计文件的格式是？"),
