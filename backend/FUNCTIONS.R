...
normalize_phos_data_to_profiling2 <- function (phospho_data_normalized, profiling_data_normalized,
  ...
  if(is.na(control_label)){ # no control, nomalization with median
    cat('\n', 'no control, nomalization with median')
    ...
    cat('\n', 'having control, nomalization with median of control')
